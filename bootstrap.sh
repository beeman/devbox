...
apt-get install git build-essential mongodb htop vim nginx php5 php-pear php5-dev php5-fpm php5-curl php5-gd php5-mcrypt php5-json libcurl4-openssl-dev gem -y -q
